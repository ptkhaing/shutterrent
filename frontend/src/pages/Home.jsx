    ...
    <div className="bg-ink-50 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <section className="py-20">
          <h3 className="font-display text-2xl sm:text-3xl text-center mb-12 text-ink-800">How It Works</h3>
          <div className="grid gap-8 text-left sm:grid-cols-3">
            {[
              ...
              <div key={item.step} className="border-t-2 border-amber-400 pt-4">
                ...
                <h4 className="text-lg font-semibold mt-2 mb-1 text-ink-800">{item.title}</h4>
                <p className="text-ink-500 text-sm sm:text-base">{item.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-16 border-t border-ink-200">
          <h3 className="font-display text-2xl sm:text-3xl text-center mb-10 text-ink-800">Why Choose Us</h3>
          <ul className="grid sm:grid-cols-2 gap-x-8 gap-y-4 max-w-3xl mx-auto text-ink-600 text-sm sm:text-base">
        ...
        {/* FAQ */}
        <section className="py-16 border-t border-ink-200 max-w-2xl mx-auto">
          <h3 className="font-display text-2xl sm:text-3xl text-center mb-10 text-ink-800">FAQ</h3>
          <div className="space-y-6 text-sm sm:text-base">
            <div>
              <h4 className="font-semibold text-ink-800">How do I rent a camera?</h4>
              <p className="text-ink-500 mt-1">Sign in, browse listings, select your dates, and confirm your booking.</p>
            </div>
            <div>
              <h4 className="font-semibold text-ink-800">Can I cancel my booking?</h4>
              <p className="text-ink-500 mt-1">Yes, bookings can be canceled anytime from your profile page.</p>
            </div>
            <div>
              <h4 className="font-semibold text-ink-800">Do I need to pay in advance?</h4>
              <p className="text-ink-500 mt-1">No — payment is cash on delivery when you receive the gear.</p>
            </div>
          </div>
        </section>
      </div>
      ...
      {/* Footer */}
      <footer className="mt-8 py-8 text-center text-ink-400 text-xs sm:text-sm border-t border-ink-200">
