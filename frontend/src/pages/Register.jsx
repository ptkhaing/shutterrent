  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ink-50 dark:bg-ink-900 px-4">
      <div className="w-full max-w-md bg-white dark:bg-ink-800 p-8 rounded-xl shadow-sm border border-ink-100 dark:border-ink-700">
        <h2 className="font-display text-3xl mb-6 text-center text-ink-800 dark:text-ink-100">Create Account</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            <label className="block mb-1 text-sm font-medium text-ink-700 dark:text-ink-200">Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block mb-1 text-sm font-medium text-ink-700 dark:text-ink-200">Confirm Password</label>
            <div className="relative">
              <input
